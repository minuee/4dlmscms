...
type CustomVariable = {
  ...
  VIDEO_FPS: number, 
  MAX_START_GAP_JUMP: number,
  FRAGMENT_DURATION: number,
  FRAME_DURATION: number,
  MS_IFRAME_PATH: string,
  S3_IFRAME_PATH: string,
  ADAPT_NAME: string, 
  URL_PATH: string,
  DIRECT_RIGHT: string,
  DIRECT_LEFT: string
...
export const hlsDefaultConfig: HlsConfig = {
  ...
  TICK_INTERVAL: 100,
  VIDEO_FPS: 30, 
  MAX_START_GAP_JUMP: 2.0,
  FRAGMENT_DURATION: 1.001,
  FRAME_DURATION: 1.001/30,
  MS_IFRAME_PATH: '_iframe/',
  S3_IFRAME_PATH: 'iframe/',
  ADAPT_NAME: 'p', 
  URL_PATH: 'p/',
  DIRECT_LEFT: 'L',
  DIRECT_RIGHT: 'R',
